...
public class Main {
	...
	private static final String INPUT = System.getProperty("user.dir");

    private static ArrayList<String[]> readInputFile(Scanner keyboard) {
	System.out.print(
		"Please enter the name (including extension and possibly path) of the txt file containing the map: ");
	Scanner file = null;
	ArrayList<String[]> map = new ArrayList<String[]>();
	do {
	    try {
		file = new Scanner(new File(INPUT + keyboard.nextLine()));
	    } catch (Exception e) {
